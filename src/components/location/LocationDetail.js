...
export const LocationDetail = () => {
  ...
  useEffect(() => {
    getLocationById(locationId).then((location) => setLocation(location));
  }, [locationId]);
  ...
  return (
    <>
      <div className="location">
        ...
        <div className="location__name line__item">{location.name}</div>
        <div className="location__address line__item">{location.address}</div>
